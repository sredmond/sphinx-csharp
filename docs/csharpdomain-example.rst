Testing the C#-Sphinx Integration
=================================
...
.. class:: MyClass
   ...
   .. variable:: MyClass z = MyClass(5, 6, 7)
...
.. interface:: MyInterface
   ...
   .. method:: void foo(int item)

.. interface:: MyGenericInterface<T>

   .. method:: void write(T item)
...
Indexer ref :idxr:`MyClass.this[int i, MyClass j]`

Interface ref :ifac:`MyInterface`

Interface method ref :meth:`MyInterface.foo`

Generic interface ref :ifac:`MyGenericInterface`

Generic interface method ref :meth:`MyGenericInterface.write`
